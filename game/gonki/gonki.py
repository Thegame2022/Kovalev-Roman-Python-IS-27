...
try:
    ...
    finish_sound = Audio('assets/finish.mp3', autoplay=False, loop=False)  # Добавлен звук финиша
...
health_bar = HealthBar(
    ...
    max_value=100,
    position=(-0.5, 0.4),  # Сдвинуто вправо
    scale=(0.4, 0.05))
...
game_over_text = Text(
    text="GAME OVER\nPress R to restart\nESC to quit",
    position=(0, 0.1),  # Центрировано по вертикали
    scale=2,
    color=color.red,
